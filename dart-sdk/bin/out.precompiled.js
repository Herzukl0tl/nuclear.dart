...
"%":"CanvasGradient|CanvasPattern|CanvasRenderingContext|CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList"},kn:{"":"bool/Gv;",
...
return!0},
static:{MW:function(a){return new P.o0(a,a.HV,a.qT,a.av,null)}}}}],["dart.core","dart:core",,P,{IL:function(a){return H.Fv(a)},hl:function(a){var z,y,x,w,v,u
...
"%":"MediaStream;EventTarget"},Yu:{"":"qE;B:length=","%":"HTMLFormElement"},Mi:{"":"qE;P:value=","%":"HTMLInputElement"},wP:{"":"qE;P:value=","%":"HTMLLIElement"},El:{"":"qE;kc:error=","%":"HTMLAudioElement|HTMLMediaElement|HTMLVideoElement"},Qb:{"":"qE;P:value=","%":"HTMLMeterElement"},KV:{"":"D0;",
bu:function(a){var z=a.nodeValue
return z==null?J.Gv.prototype.bu.call(this,a):z},
"%":"Document|HTMLDocument;Node"},Ql:{"":"qE;P:value=","%":"HTMLOptionElement"},wL:{"":"qE;P:value=","%":"HTMLOutputElement"},HD:{"":"qE;P:value=","%":"HTMLParamElement"},KR:{"":"qE;P:value=","%":"HTMLProgressElement"},lp:{"":"qE;B:length=,P:value=","%":"HTMLSelectElement"},zD:{"":"ea;kc:error=","%":"SpeechRecognitionError"},FB:{"":"qE;P:value=","%":"HTMLTextAreaElement"},Oi:{"":"D0;",
bu:function(a){return a.toString()},
...
$isqC:true,
$isXj:true,
"%":";Uint8Array"},xG:{"":"AS+lD;",$isList:true,$asWO:null,$isqC:true},Vj:{"":"xG+SU;",$asWO:null}}],["sunflower","/Users/adriencarta/dart/sunflower/web/sunflower.dart",,B,{Iq:function(){var z,y
z=$.Aj()
z.toString
z=new W.Cq(z,C.mt.Ph,!1)
H.VM(z,[null])
y=new W.xC(0,z.uv,z.Ph,W.VF(new B.em()),z.Sg)
H.VM(y,[H.W8(z,"RO",0)])
y.Zz()
B.E2()},E2:function(){var z,y,x,w
$.e9=H.Hp(J.Vm($.Aj()),null,null)
$.cM().clearRect(0,0,300,300)
z=0
while(!0){y=$.e9
...
w=Math.sqrt(z)*4
y=Math.cos(x)
B.CO(150+w*y,150-w*Math.sin(x));++z}$.oY().textContent=H.d($.e9)+" seeds"},CO:function(a,b){var z=$.cM()
z.beginPath()
z.lineWidth=2
z.fillStyle="orange"
z.strokeStyle="orange"
z.arc(a,b,2,0,6.283185307179586,!1)
z.fill()
z.closePath()
z.stroke()},em:{"":"Tp;",
call$1:function(a){return B.E2()},
$is_aB:true}},1],])
...
I.$lazy($,"notes","tQ","oY",function(){return document.querySelector("#notes")})
I.$lazy($,"PHI","MQ","M8",function(){return(Math.sqrt(5)+1)/2})
I.$lazy($,"context","eo","cM",function(){var z=H.Go(document.querySelector("#canvas"),"$isNy")
z.toString
